...
export const IconCheck = () => (
  <svg className="h-6 w-6" aria-hidden="true" {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
...
export const IconTextSize = () => (
  <svg className="h-6 w-6" {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconClose = (cprops) => (
  <svg className={cprops.className || "h-6 w-6"} {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconRefresh = () => (
  <svg className="h-8 w-8" {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconFolderMove = () => (
  <svg className="h-5 w-5" {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconArrowDown = () => (
  <svg className="ms-2.5 h-2.5 w-2.5" {...props} viewBox="0 0 10 6">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconSearch = () => (
  <svg className="mx-4 h-4 w-4" {...props} viewBox="0 0 20 20">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconChevronArrowDown = () => (
  <svg className="h-6 w-6 cursor-pointer" {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const IconBookmark = ({ cls = "h-6 w-6" }) => (
  <svg className={cls} {...props} viewBox="0 0 24 24">
    <path
      stroke="currentColor"
      fill="currentColor"
      stroke-linecap="round"
